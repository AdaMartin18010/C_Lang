...
- [GCC 15 C23 默认支持完整指南](#gcc-15-c23-默认支持完整指南)
  - [目录](#目录)
  - [1. GCC 15 概览](#1-gcc-15-概览)
    - [1.1 发布信息](#11-发布信息)
    - [1.2 重大变化](#12-重大变化)
      - [1.2.1 默认标准变化](#121-默认标准变化)
      - [1.2.2 为什么这个变化很重要](#122-为什么这个变化很重要)
    - [1.3 与 GCC 14 的详细对比](#13-与-gcc-14-的详细对比)
      - [1.3.1 编译器行为对比](#131-编译器行为对比)
      - [1.3.2 新增警告和检查](#132-新增警告和检查)
      - [1.3.3 性能改进对比](#133-性能改进对比)
    - [1.4 安装和获取](#14-安装和获取)
      - [1.4.1 源码编译安装](#141-源码编译安装)
      - [1.4.2 各大发行版获取](#142-各大发行版获取)
      - [1.4.3 验证安装](#143-验证安装)
  - [2. C23 默认支持详解](#2-c23-默认支持详解)
    - [2.1 -std=c23 现在默认](#21--stdc23-现在默认)
      - [2.1.1 标准选项说明](#211-标准选项说明)
      - [2.1.2 编译命令对比](#212-编译命令对比)
    - [2.2 -std=gnu23 默认扩展](#22--stdgnu23-默认扩展)
      - [2.2.1 GNU 扩展概览](#221-gnu-扩展概览)
      - [2.2.2 语句表达式示例](#222-语句表达式示例)
      - [2.2.3 typeof 关键字](#223-typeof-关键字)
    - [2.3 与旧版本的兼容性](#23-与旧版本的兼容性)
      - [2.3.1 向后兼容策略](#231-向后兼容策略)
      - [2.3.2 特性检测宏](#232-特性检测宏)
      - [2.3.3 版本相关宏参考](#233-版本相关宏参考)
    - [2.4 迁移指南](#24-迁移指南)
      - [2.4.1 从 C17 迁移到 C23](#241-从-c17-迁移到-c23)
      - [2.4.2 项目级迁移策略](#242-项目级迁移策略)
      - [2.4.3 库兼容性矩阵](#243-库兼容性矩阵)
  - [3. glibc 支持更新](#3-glibc-支持更新)
    - [3.1 glibc 2.41: C23/POSIX.1-2024 支持](#31-glibc-241-c23posix1-2024-支持)
      - [3.1.1 发布信息](#311-发布信息)
      - [3.1.2 C23 头文件支持](#312-c23-头文件支持)
      - [3.1.3 POSIX.1-2024 新特性](#313-posix1-2024-新特性)
    - [3.2 glibc 2.42: Math 和 Malloc 优化](#32-glibc-242-math-和-malloc-优化)
      - [3.2.1 数学库优化](#321-数学库优化)
      - [3.2.2 Malloc 优化](#322-malloc-优化)
    - [3.3 glibc 2.43: FMA 实现 (4x-12.9x 性能提升)](#33-glibc-243-fma-实现-4x-129x-性能提升)
      - [3.3.1 FMA (Fused Multiply-Add) 说明](#331-fma-fused-multiply-add-说明)
      - [3.3.2 性能提升数据](#332-性能提升数据)
      - [3.3.3 使用 FMA 的代码示例](#333-使用-fma-的代码示例)
    - [3.4 \_ISOC2Y\_SOURCE 测试宏](#34-_isoc2y_source-测试宏)
      - [3.4.1 功能说明](#341-功能说明)
      - [3.4.2 使用方法](#342-使用方法)
      - [3.4.3 特性测试宏对照表](#343-特性测试宏对照表)
      - [3.4.4 综合特性控制示例](#344-综合特性控制示例)
  - [4. 新增 C23 库函数](#4-新增-c23-库函数)
    - [4.1 新增数学函数](#41-新增数学函数)
      - [4.1.1 圆周率相关函数](#411-圆周率相关函数)
      - [4.1.2 新增数学函数的优势](#412-新增数学函数的优势)
      - [4.1.3 其他新增数学函数](#413-其他新增数学函数)
    - [4.2 timespec\_getres](#42-timespec_getres)
      - [4.2.1 函数说明](#421-函数说明)
      - [4.2.2 使用示例](#422-使用示例)
      - [4.2.3 高精度计时器实现](#423-高精度计时器实现)
    - [4.3 memset\_explicit](#43-memset_explicit)
      - [4.3.1 函数说明](#431-函数说明)
      - [4.3.2 为什么需要 memset\_explicit](#432-为什么需要-memset_explicit)
      - [4.3.3 安全密码处理示例](#433-安全密码处理示例)
      - [4.3.4 对比表: 内存清除函数](#434-对比表-内存清除函数)
    - [4.4 strdup, strndup, memccpy](#44-strdup-strndup-memccpy)
      - [4.4.1 strdup 和 strndup](#441-strdup-和-strndup)
      - [4.4.2 memccpy](#442-memccpy)
      - [4.4.3 字符串处理函数对比](#443-字符串处理函数对比)
    - [4.5 gmtime\_r, localtime\_r](#45-gmtime_r-localtime_r)
      - [4.5.1 函数说明](#451-函数说明)
      - [4.5.2 线程安全时间处理](#452-线程安全时间处理)
      - [4.5.3 时间处理工具函数](#453-时间处理工具函数)
  - [5. 编译器优化](#5-编译器优化)
    - [5.1 早期 break 循环向量化](#51-早期-break-循环向量化)
      - [5.1.1 优化原理](#511-优化原理)
      - [5.1.2 性能对比](#512-性能对比)
      - [5.1.3 优化代码示例](#513-优化代码示例)
    - [5.2 SIMD 文本处理优化](#52-simd-文本处理优化)
      - [5.2.1 字符串处理向量化](#521-字符串处理向量化)
      - [5.2.2 性能基准](#522-性能基准)
      - [5.2.3 高级文本处理示例](#523-高级文本处理示例)
    - [5.3 AMD Zen 4 优化](#53-amd-zen-4-优化)
      - [5.3.1 Zen 4 架构特性](#531-zen-4-架构特性)
      - [5.3.2 编译器标志](#532-编译器标志)
      - [5.3.3 Zen 4 优化的 AVX-512 代码](#533-zen-4-优化的-avx-512-代码)
      - [5.3.4 Zen 4 性能数据](#534-zen-4-性能数据)
  - [6. 代码示例](#6-代码示例)
    - [6.1 使用 C23 新特性的完整示例](#61-使用-c23-新特性的完整示例)
      - [6.1.1 C23 现代 C 程序模板](#611-c23-现代-c-程序模板)
    - [6.2 编译命令对比](#62-编译命令对比)
      - [6.2.1 不同场景下的编译命令](#621-不同场景下的编译命令)
    - [6.3 性能测试示例](#63-性能测试示例)
      - [6.3.1 综合性能测试套件](#631-综合性能测试套件)
  - [7. GCC 15 vs Clang 22 vs MSVC](#7-gcc-15-vs-clang-22-vs-msvc)
    - [7.1 C23 特性支持矩阵](#71-c23-特性支持矩阵)
      - [7.1.1 核心语言特性](#711-核心语言特性)
      - [7.1.2 属性支持](#712-属性支持)
      - [7.1.3 预处理器特性](#713-预处理器特性)
      - [7.1.4 库特性](#714-库特性)
    - [7.2 C2y 特性支持矩阵](#72-c2y-特性支持矩阵)
      - [7.2.1 实验性 C2y 特性](#721-实验性-c2y-特性)
    - [7.3 推荐使用策略](#73-推荐使用策略)
      - [7.3.1 平台选择建议](#731-平台选择建议)
