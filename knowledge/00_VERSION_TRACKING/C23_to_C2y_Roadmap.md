...
| **N3472 auto** | 占位类型推导 `auto x = 1;` | 讨论中 | 高 |
| **N3753 Elvis** | `?:`操作符增强 | 审议中 | 中 |
| **N3745 依赖结构体** | Dependent Structure Types | 审议中 | 中 |
| **N3694 闭包** | Functions with Data: Closures in C | 讨论中 | 中 |
| **N3690 线程属性** | Thread Attributes | 讨论中 | 中 |
| **模块化** | import/export替代头文件 | 讨论中 | 中 |
| **概念/约束** | 类型约束泛型 | 早期 | 低 |
| **模式匹配** | switch表达式增强 | 讨论中 | 中 |
| **N3679 函数字面量** | Function literals/lambdas | 讨论中 | 中 |
| **N3747 整数集合** | 集合类型与操作 | 审议中 | 中 |
