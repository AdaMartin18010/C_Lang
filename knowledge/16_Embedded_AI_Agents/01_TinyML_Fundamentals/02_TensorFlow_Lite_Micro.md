...
- [TensorFlow Lite Micro 嵌入式部署指南](#tensorflow-lite-micro-嵌入式部署指南)
  - [目录](#目录)
  - [概述](#概述)
    - [什么是TensorFlow Lite Micro？](#什么是tensorflow-lite-micro)
      - [核心特性](#核心特性)
      - [TFLM vs TFLite vs TensorFlow](#tflm-vs-tflite-vs-tensorflow)
  - [TFLM架构介绍](#tflm架构介绍)
    - [系统架构](#系统架构)
  - [开发环境搭建](#开发环境搭建)
    - [支持的平台](#支持的平台)
