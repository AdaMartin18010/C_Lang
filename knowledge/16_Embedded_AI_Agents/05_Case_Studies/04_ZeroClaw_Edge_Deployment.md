...
- [案例研究: ZeroClaw边缘部署](#案例研究-zeroclaw边缘部署)
  - [项目概述](#项目概述)
    - [目标](#目标)
    - [硬件配置](#硬件配置)
    - [软件栈](#软件栈)
  ...
  - [实施步骤](#实施步骤)
    - [步骤1: 系统准备](#步骤1-系统准备)
    - [步骤2: 编译和安装llama.cpp](#步骤2-编译和安装llamacpp)
    - [步骤3: 下载和配置模型](#步骤3-下载和配置模型)
    - [步骤4: 构建数据采集服务 (C++)](#步骤4-构建数据采集服务-c)
    - [步骤5: ZeroClaw Agent配置](#步骤5-zeroclaw-agent配置)
    - [步骤6: Docker Compose编排](#步骤6-docker-compose编排)
  - [性能指标](#性能指标)
    - [实测性能 (Raspberry Pi 5, 8GB)](#实测性能-raspberry-pi-5-8gb)
    - [优化结果](#优化结果)
  - [故障排除](#故障排除)
    - [常见问题](#常见问题)
  - [总结](#总结)
