...
| 路径 | 起点 | 终点 | 关键文档 |
|:-----|:-----|:-----|:---------|
| **系统编程** | Linux内核模块 | [eBPF深度](./03_System_Technology_Domains/01_System_Programming/06_eBPF_Deep.md) | 调度、内存、I/O |
...
**知识库入口**: [01_Core_Knowledge_System/README.md](./01_Core_Knowledge_System/README.md)
