...
> **对应标准**: ISO/IEC 9899, CERT C, MISRA C
> **难度级别**: L3 应用 → L4 分析
> **预估学习时间**: 15-20 小时
...
- [C 语言软件工程层指南](#c-语言软件工程层指南)
  - [🔗 文档关联网络](#-文档关联网络)
    - [前置知识 (核心层/构造层)](#前置知识-核心层构造层)
    - [本层关联](#本层关联)
    - [后续延伸](#后续延伸)
    - [工程实践体系](#工程实践体系)
  - [📑 目录](#-目录)
  ...
  - [项目结构设计](#项目结构设计)
    ...
    - [版本管理](#版本管理)
  - [版本控制工作流](#版本控制工作流)
    - [Git 分支策略 (Git Flow)](#git-分支策略-git-flow)
    - [提交信息规范](#提交信息规范)
    - [版本标记脚本](#版本标记脚本)
  - [代码审查](#代码审查)
    - [审查清单](#审查清单)
