...
| 提案 | 特性 | 状态 | 文档 |
|:-----|:-----|:-----|:-----|
| N3734/N3853 | `defer` 关键字 | TS CD r5 | [详解](01_Defer_Keyword.md) |
...
| 提案 | GCC | Clang | 预计版本 |
|:-----|:----|:------|:---------|
| defer | 15+ (实验性, `-std=c2y`) | 20+ (计划中) | 标准支持待定 |
| Elvis | 扩展已支持 | 扩展已支持 | 标准形式待定 |
| Named Loops | 15+ | 20+ | 标准支持待定 |
| **COUNTER** | 扩展已支持 | 扩展已支持 | 标准形式待定 |
| typeof(return) | 扩展已支持 | 扩展已支持 | 标准支持待定 |
