...
| 文档 | 关系类型 | 说明 |
|:-----|:---------|:-----|
| [数据类型系统](../01_Basic_Layer/02_Data_Type_System.md) | 知识基础 | 复合类型、数组类型定义 |
| [指针深度](01_Pointer_Depth.md) | 核心依赖 | 指针运算、数组-指针等价关系 |
...
| 文档 | 关系类型 | 说明 |
|:-----|:---------|:-----|
| [内存管理](02_Memory_Management.md) | 直接延伸 | 动态数组、柔性数组实现 |
| [字符串处理](03_String_Processing.md) | 直接应用 | 字符数组操作基础 |
| [函数指针 [链接失效]](03_Function_Pointers.md) | 间接延伸 | 指针进阶应用 |
