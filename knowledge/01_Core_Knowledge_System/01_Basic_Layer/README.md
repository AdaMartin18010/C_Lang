...
> **对应标准**: ISO/IEC 9899:2018 §5, §6.4-6.8
> **难度级别**: L1 入门 → L2 理解
> **预估学习时间**: 25-35 小时
...
| 文档 | 主题 | 后续关联 |
|:-----|:-----|:---------|
| [语法要素](01_Syntax_Elements.md) | 词法语法 | 预处理器、编译 |
| [数据类型系统](02_Data_Type_System.md) | 类型基础 | 指针、结构体 |
| [运算符与表达式](03_Operators_Expressions.md) | 计算基础 | 指针运算 |
| [控制流程](04_Control_Flow.md) | 程序流程 | 函数、状态机 |

### 向核心层进阶

| 文档 | 关系 | 说明 |
|:-----|:-----|:-----|
| [指针深度](../02_Core_Layer/01_Pointer_Depth.md) | 核心进阶 | 基础类型的指针扩展 |
| [内存管理](../02_Core_Layer/02_Memory_Management.md) | 核心进阶 | 动态内存概念 |
| [函数与作用域](../02_Core_Layer/04_Functions_Scope.md) | 核心进阶 | 函数深入理解 |
