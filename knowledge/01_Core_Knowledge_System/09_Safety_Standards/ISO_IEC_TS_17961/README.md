...
- [ISO/IEC TS 17961: C Secure Coding Rules](#isoiec-ts-17961-c-secure-coding-rules)
  - [📑 目录](#-目录)
  - [标准概述](#标准概述)
  - [标准目的](#标准目的)
    - [核心目标](#核心目标)
  ...
  - [技术规范详解](#技术规范详解)
    - [规则分类结构](#规则分类结构)
    - [关键规则详解](#关键规则详解)
      - [规则 5.1: 调用 `system()` 函数](#规则-51-调用-system-函数)
      - [规则 5.4: 整数溢出 (有符号)](#规则-54-整数溢出-有符号)
      - [规则 5.22: 重复释放内存](#规则-522-重复释放内存)
      - [规则 5.36: 污染字符串传递给字符串复制函数](#规则-536-污染字符串传递给字符串复制函数)
  - [静态分析器合规性要求](#静态分析器合规性要求)
    - [分析器分类](#分析器分类)
    - [可诊断性要求](#可诊断性要求)
  - [规则与 CWE 映射](#规则与-cwe-映射)
  - [合规验证方法](#合规验证方法)
    - [自动化验证工具](#自动化验证工具)
      - [1. GrammaTech CodeSonar](#1-grammatech-codesonar)
      - [2. Klocwork](#2-klocwork)
      - [3. LDRA](#3-ldra)
    - [合规性报告模板](#合规性报告模板)
  - [与 MISRA C:2025 协同使用](#与-misra-c2025-协同使用)
    - [联合合规策略](#联合合规策略)
  - [未来演进](#未来演进)
    - [ISO/IEC TS 17961 Part 2 (开发中)](#isoiec-ts-17961-part-2-开发中)
    - [与新兴标准的关系](#与新兴标准的关系)
  - [参考文档](#参考文档)
  - [深入理解](#深入理解)
    - [技术原理](#技术原理)
