...
- [形式化验证工业案例研究 (2024-2025)](#形式化验证工业案例研究-2024-2025)
  - [📑 目录](#-目录)
  - [概述](#概述)
  - [1. CompCert 验证编译器](#1-compcert-验证编译器)
    - [项目背景](#项目背景)
    - [验证架构](#验证架构)
    - [语义保持定理](#语义保持定理)
    - [工业应用](#工业应用)
  - [2. seL4 形式化验证微内核](#2-sel4-形式化验证微内核)
    - [项目背景](#项目背景-1)
    - [验证性质](#验证性质)
    - [系统调用验证示例](#系统调用验证示例)
    - [性能对比](#性能对比)
  - [3. AWS Encryption SDK 验证](#3-aws-encryption-sdk-验证)
    - [HACL\* 加密库](#hacl-加密库)
    - [EverCrypt 统一 API](#evercrypt-统一-api)
  - [4. Frama-C 工业应用案例](#4-frama-c-工业应用案例)
    - [Airbus A350 飞行控制](#airbus-a350-飞行控制)
    - [Dassault Aviation](#dassault-aviation)
  - [5. 形式化验证 ROI 分析](#5-形式化验证-roi-分析)
    - [成本效益对比](#成本效益对比)
    - [适用场景建议](#适用场景建议)
  - [6. 2025 前沿趋势](#6-2025-前沿趋势)
    - [LLM 辅助形式化证明](#llm-辅助形式化证明)
    - [神经网络验证 (VNN-COMP 2024)](#神经网络验证-vnn-comp-2024)
  - [参考资源](#参考资源)
    - [重要论文](#重要论文)
    - [在线资源](#在线资源)
  - [深入理解](#深入理解)
