...
- [MISRA C:2023 Rules 3.1-3.4 - 注释规范](#misra-c2023-rules-31-34---注释规范)
  - [规则分类概述](#规则分类概述)
  - [📑 目录](#-目录)
  - [Rule 3.1 - 注释格式正确性](#rule-31---注释格式正确性)
    - [规则原文](#规则原文)
    - [详细解释](#详细解释)
    - [违反示例](#违反示例)
    - [合规示例](#合规示例)
    - [特殊情况处理](#特殊情况处理)
  - [Rule 3.2 - 代码序列化（Rule 2.2修订）](#rule-32---代码序列化rule-22修订)
    - [规则原文](#规则原文-1)
    - [行拼接是什么](#行拼接是什么)
    - [违反示例](#违反示例-1)
    - [合规示例](#合规示例-1)
  - [Rule 3.3 - 禁止嵌套注释](#rule-33---禁止嵌套注释)
    - [规则原文](#规则原文-2)
    - [本质问题](#本质问题)
    - [违反示例](#违反示例-2)
    - [合规示例](#合规示例-2)
    - [注释代码的最佳实践](#注释代码的最佳实践)
  - [Rule 3.4 - 文档注释（Advisory）](#rule-34---文档注释advisory)
    - [规则原文](#规则原文-3)
    - [文档化要求](#文档化要求)
    - [推荐文档格式（Doxygen风格）](#推荐文档格式doxygen风格)
    - [Doxygen标记速查表](#doxygen标记速查表)
  - [综合最佳实践](#综合最佳实践)
    - [注释风格指南](#注释风格指南)
    - [注释检查清单](#注释检查清单)
  - [总结](#总结)
