...
- [C 语言国际化与本地化 (i18n/l10n)](#c-语言国际化与本地化-i18nl10n)
  - [📑 目录](#-目录)
  - [概述](#概述)
  - [标准国际化架构](#标准国际化架构)
    - [POSIX Locale 模型](#posix-locale-模型)
    - [C 标准支持](#c-标准支持)
  - [Unicode 与字符编码](#unicode-与字符编码)
    - [UTF-8 在 C 语言中的实现](#utf-8-在-c-语言中的实现)
    - [宽字符 (Wide Characters)](#宽字符-wide-characters)
  - [GNU gettext 框架](#gnu-gettext-框架)
    - [基础架构](#基础架构)
    - [代码标记示例](#代码标记示例)
    - [复数形式处理](#复数形式处理)
  - [ICU (International Components for Unicode)](#icu-international-components-for-unicode)
    - [工业级国际化库](#工业级国际化库)
  - [跨平台文本处理](#跨平台文本处理)
    - [字符串外部化最佳实践](#字符串外部化最佳实践)
    - [RTL (从右到左) 语言支持](#rtl-从右到左-语言支持)
  - [本地化格式处理](#本地化格式处理)
    - [数字和货币格式](#数字和货币格式)
    - [日期时间本地化](#日期时间本地化)
  - [工具链集成](#工具链集成)
    - [xgettext 提取流程](#xgettext-提取流程)
    - [现代构建系统集成](#现代构建系统集成)
  - [测试与验证](#测试与验证)
