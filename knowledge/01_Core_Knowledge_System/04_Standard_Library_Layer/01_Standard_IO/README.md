...
| 文档 | 关系类型 | 说明 |
|:-----|:---------|:-----|
| [指针深度](../../02_Core_Layer/01_Pointer_Depth.md) | 核心依赖 | FILE指针、缓冲区指针 |
| [内存管理](../../02_Core_Layer/02_Memory_Management.md) | 安全基础 | 缓冲区分配、内存映射 |
| [字符串处理](../../02_Core_Layer/03_String_Processing.md) | 知识基础 | 格式化I/O中的字符串 |
...
| [文件系统](../../03_System_Technology_Domains/01_System_Programming/02_File_System_Operations.md) | 系统应用 | 系统级文件操作 |
...
| [内存映射](../../03_System_Technology_Domains/01_System_Programming/05_Memory_Mapped_Files.md) | 性能优化 | 替代方案对比 |
