...
| 文档 | 关系类型 | 说明 |
|:-----|:---------|:-----|
| [C11标准库](../03_C11_Library.md) | 版本基础 | C11标准库是C23的基础 |
| [现代C编程](../../07_Modern_C/readme.md) | 语言特性 | C23语言新特性 |
| [位运算 [链接失效]](../../01_Basic_Layer/06_Bit_Operations.md) | 知识基础 | stdbit.h的基础 |
...
| [安全编码](../../09_Safety_Standards/04_Secure_Coding_Guide.md) | 安全实践 | stdckdint.h安全应用 |

### 版本演进

| 标准 | 文档 | 关键特性 |
|:-----|:-----|:---------|
| C89 | [C89标准库](../01_C89_Library.md) | 基础库函数 |
| C99 | [C99标准库](../02_C99_Library.md) | 复数、宽字符 |
| C11 | [C11标准库](../03_C11_Library.md) | 线程、原子操作 |
| C17 | [C17/C23库](../04_C17_C23_Library.md) | C17修复、C23新特性 |
| C23 | 本文档 | nullptr、stdbit、stdckdint |
