...
- [ONNX Runtime C API](#onnx-runtime-c-api)
  - [1. ONNX概述](#1-onnx概述)
    - [1.1 为什么使用ONNX Runtime](#11-为什么使用onnx-runtime)
    - [1.2 工作流程](#12-工作流程)
  - [📑 目录](#-目录)
  - [2. 环境搭建](#2-环境搭建)
    - [2.1 安装ONNX Runtime](#21-安装onnx-runtime)
    - [2.2 链接配置](#22-链接配置)
  - [3. C API基础](#3-c-api基础)
    - [3.1 头文件与初始化](#31-头文件与初始化)
    - [3.2 环境与会话](#32-环境与会话)
  - [4. 模型推理](#4-模型推理)
    - [4.1 查询模型信息](#41-查询模型信息)
    - [4.2 创建输入张量](#42-创建输入张量)
    - [4.3 执行推理](#43-执行推理)
  - [5. 完整示例：MNIST推理](#5-完整示例mnist推理)
  - [6. 性能优化](#6-性能优化)
    - [6.1 执行提供者](#61-执行提供者)
    - [6.2 量化模型](#62-量化模型)
    - [6.3 动态形状](#63-动态形状)
