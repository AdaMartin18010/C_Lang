...
| **前置知识** | C语言基础、SIMD优化、[内存管理](../../01_Core_Knowledge_System/02_Core_Layer/02_Memory_Management.md) |
| **后续延伸** | [ESP32开发](../../04_Industrial_Scenarios/14_Embedded_IoT/ESP32/README.md)、STM32编程 |
| **横向关联** | [嵌入式系统](../../01_Core_Knowledge_System/08_Application_Domains/02_Embedded_Systems.md)、实时系统 |
