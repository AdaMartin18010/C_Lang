...
- [Raft Leader选举与安全性](#raft-leader选举与安全性)
  - [📋 本节概要](#-本节概要)
  - [📑 目录](#-目录)
  - [🧠 知识结构思维导图](#-知识结构思维导图)
  - [1. 概述](#1-概述)
  - [2. 状态机与角色转换](#2-状态机与角色转换)
    - [2.1 节点状态定义](#21-节点状态定义)
    - [2.2 状态转换逻辑](#22-状态转换逻辑)
  - [3. Leader选举实现](#3-leader选举实现)
    - [3.1 选举超时与触发](#31-选举超时与触发)
    - [3.2 发起选举](#32-发起选举)
    - [3.3 处理投票响应](#33-处理投票响应)
  - [4. 心跳机制](#4-心跳机制)
    - [4.1 Leader心跳发送](#41-leader心跳发送)
  - [⚠️ 常见陷阱](#️-常见陷阱)
  - [✅ 质量验收清单](#-质量验收清单)
  - [📚 参考与延伸阅读](#-参考与延伸阅读)
