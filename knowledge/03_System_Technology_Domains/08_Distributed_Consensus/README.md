...
> **层级定位**: 03_System_Technology_Domains > 08_Distributed_Consensus
> **难度等级**: L4-L5 | **预估学习时间**: 35-45小时
> **前置知识**: 分布式系统、网络编程、并发控制、容错理论
...
| 类型 | 代表算法 | 容错能力 |
|:-----|:---------|:---------|
| 崩溃容错 | Raft、Paxos | f < n/2 |
| 拜占庭容错 | PBFT、Tendermint | f < n/3 |
| 嵌入式 | Raft-OM | 资源受限优化 |
