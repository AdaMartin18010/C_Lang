...
- [C 语言计算机视觉开发指南](#c-语言计算机视觉开发指南)
  - [📑 目录](#-目录)
  - [概述](#概述)
  - [OpenCV C API 基础](#opencv-c-api-基础)
    - [安装与配置](#安装与配置)
    - [基本图像操作](#基本图像操作)
      - [图像读取与显示](#图像读取与显示)
      - [编译命令](#编译命令)
  ...
  - [特征检测与匹配](#特征检测与匹配)
    ...
    - [SIFT 特征提取（使用 OpenCV 2.x 接口）](#sift-特征提取使用-opencv-2x-接口)
    - [模板匹配](#模板匹配)
  - [颜色空间与直方图](#颜色空间与直方图)
    - [颜色空间转换](#颜色空间转换)
    - [直方图计算与均衡化](#直方图计算与均衡化)
  - [性能优化技巧](#性能优化技巧)
    - [ROI (感兴趣区域) 处理](#roi-感兴趣区域-处理)
    - [内存管理最佳实践](#内存管理最佳实践)
  - [综合示例：实时人脸检测](#综合示例实时人脸检测)
  - [总结](#总结)
