...
> **横向关联**: [Nand2Tetris VM规范](https://www.nand2tetris.org/project07), [现有VM内容](../03_System_Technology_Domains/24_Virtual_Machine_Interpreter/README.md)
> **预计学习时间**: 2周
> **实践验证**: stack_vm.c
...
| 相关文档 | 连接点 |
|:---------|:-------|
| [现有VM内容](../03_System_Technology_Domains/24_Virtual_Machine_Interpreter/README.md) | 不同类型的虚拟机对比 |
| [JIT编译](../03_System_Technology_Domains/24_Virtual_Machine_Interpreter/03_JIT_Compilation.md) | VM字节码的动态编译 |
