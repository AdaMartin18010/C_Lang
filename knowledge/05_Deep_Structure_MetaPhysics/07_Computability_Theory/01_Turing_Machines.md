...
- [图灵机：计算的本质与物理实现](#图灵机计算的本质与物理实现)
  - [📋 本节概要](#-本节概要)
  - [📑 目录](#-目录)
  - [🧠 核心问题：什么是可计算的？](#-核心问题什么是可计算的)
    - [从物理到抽象的映射](#从物理到抽象的映射)
  - [📖 1. 图灵机的形式化定义](#-1-图灵机的形式化定义)
    - [1.1 七元组定义](#11-七元组定义)
    - [1.2 C语言实现](#12-c语言实现)
  - [📖 2. 示例：具体图灵机实现](#-2-示例具体图灵机实现)
    - [2.1 识别语言 0^n1^n](#21-识别语言-0n1n)
    - [2.2 二进制加法器图灵机](#22-二进制加法器图灵机)
  - [📖 3. 通用图灵机](#-3-通用图灵机)
    - [3.1 核心思想](#31-核心思想)
    - [3.2 实现思路](#32-实现思路)
    - [3.3 丘奇-图灵论题](#33-丘奇-图灵论题)
  - [📖 4. 不可计算问题](#-4-不可计算问题)
    - [4.1 停机问题](#41-停机问题)
    - [4.2 C语言模拟](#42-c语言模拟)
  - [📖 5. 从图灵机到物理计算机](#-5-从图灵机到物理计算机)
    - [5.1 存储程序概念](#51-存储程序概念)
    - [5.2 有限 vs 无限的现实](#52-有限-vs-无限的现实)
  - [⚠️ 常见陷阱](#️-常见陷阱)
    - [陷阱 TM01: 混淆识别与判定](#陷阱-tm01-混淆识别与判定)
    - [陷阱 TM02: 忽视编码方式](#陷阱-tm02-忽视编码方式)
  - [📚 参考资源](#-参考资源)
    - [原始论文](#原始论文)
    - [教材](#教材)
    - [扩展阅读](#扩展阅读)
