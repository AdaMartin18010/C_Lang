...
- [memcpy SIMD优化](#memcpy-simd优化)
  - [📋 本节概要](#-本节概要)
  - [📑 目录](#-目录)
  - [🧠 知识结构思维导图](#-知识结构思维导图)
  - [📖 核心概念详解](#-核心概念详解)
    - [1. SIMD指令集概述](#1-simd指令集概述)
      - [1.1 x86 SIMD演进](#11-x86-simd演进)
      - [1.2 各指令集特点](#12-各指令集特点)
    - [2. 高级优化技术](#2-高级优化技术)
      - [2.1 非临时存储](#21-非临时存储)
      - [2.2 软件预取](#22-软件预取)
      - [2.3 对齐处理策略](#23-对齐处理策略)
    - [3. 性能优化实践](#3-性能优化实践)
      - [3.1 大小分级策略](#31-大小分级策略)
      - [3.2 多线程memcpy](#32-多线程memcpy)
    - [4. ARM NEON优化](#4-arm-neon优化)
  - [⚠️ 常见陷阱](#️-常见陷阱)
    - [陷阱 SIMD01: 未检查CPU特性](#陷阱-simd01-未检查cpu特性)
    - [陷阱 SIMD02: 忽略非临时存储的fence](#陷阱-simd02-忽略非临时存储的fence)
    - [陷阱 SIMD03: 小拷贝的过度优化](#陷阱-simd03-小拷贝的过度优化)
  - [✅ 质量验收清单](#-质量验收清单)
  - [📚 参考资源](#-参考资源)
