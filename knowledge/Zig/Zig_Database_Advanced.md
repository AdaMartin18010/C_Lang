# Zig 数据库高级：从 SQLite 到自定义存储

> **定位**: Zig 应用 / 数据库 | **难度**: ⭐⭐⭐⭐⭐ | **目标**: 掌握 Zig 数据库开发

---

## 📋 目录

- [Zig 数据库高级：从 SQLite 到自定义存储](#zig-数据库高级从-sqlite-到自定义存储)
  - [📋 目录](#-目录)
  - [📑 目录](#-目录-1)
  - [一、数据库架构](#一数据库架构)
  - [二、SQLite 高级](#二sqlite-高级)
    - [2.1 连接池](#21-连接池)
    - [2.2 异步查询](#22-异步查询)
    - [2.3 迁移系统](#23-迁移系统)
  - [三、自定义存储引擎](#三自定义存储引擎)
