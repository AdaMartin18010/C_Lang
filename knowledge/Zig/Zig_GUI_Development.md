...
> **定位**: Zig 应用 / GUI 开发 | **难度**: ⭐⭐⭐⭐ | **目标**: 掌握 Zig 桌面应用开发

---

## 📋 目录

- [Zig GUI 开发：桌面应用构建](#zig-gui-开发桌面应用构建)
  - [📋 目录](#-目录)
  - [📑 目录](#-目录-1)
  - [一、GUI 框架选择](#一gui-框架选择)
  - [二、Immediate Mode GUI](#二immediate-mode-gui)
    - [2.1 ZGUI (Dear ImGui 绑定)](#21-zgui-dear-imgui-绑定)
    - [2.2 自定义绘制](#22-自定义绘制)
  - [三、Retained Mode GUI](#三retained-mode-gui)
    - [3.1 GTK 绑定](#31-gtk-绑定)
  - [四、自定义控件](#四自定义控件)
  - [五、事件处理](#五事件处理)
  - [六、绘图与渲染](#六绘图与渲染)
  - [七、实战：编辑器应用](#七实战编辑器应用)
...
## 二、Immediate Mode GUI

### 2.1 ZGUI (Dear ImGui 绑定)
