...
- [并发安全层次依赖图](#并发安全层次依赖图)
  - [🔗 文档关联](#-文档关联)
    ...
    - [扩展阅读](#扩展阅读)
  - [](#)
  - [一、并发安全层次金字塔](#一并发安全层次金字塔)
  - [📑 目录](#-目录)
  - [二、并发原语 × 适用场景 选择矩阵](#二并发原语--适用场景-选择矩阵)
  - [三、内存序 × 使用场景 匹配矩阵](#三内存序--使用场景-匹配矩阵)
  - [四、并发问题 → 解决方案 映射](#四并发问题--解决方案-映射)
  - [五、C标准 × 并发支持 演进矩阵](#五c标准--并发支持-演进矩阵)
  - [六、并发安全决策树](#六并发安全决策树)
  - [七、锁机制深度解析](#七锁机制深度解析)
    - [7.1 互斥锁实现原理](#71-互斥锁实现原理)
    - [7.2 读写锁机制](#72-读写锁机制)
    - [7.3 自旋锁与互斥锁选择](#73-自旋锁与互斥锁选择)
  - [八、原子操作与内存序](#八原子操作与内存序)
    - [8.1 C11 原子操作示例](#81-c11-原子操作示例)
    - [8.2 内存序可视化](#82-内存序可视化)
  - [九、无锁数据结构](#九无锁数据结构)
    - [9.1 无锁栈 (Treiber Stack)](#91-无锁栈-treiber-stack)
    - [9.2 无锁队列 (MPSC)](#92-无锁队列-mpsc)
  - [十、死锁预防策略](#十死锁预防策略)
  - [深入理解](#深入理解)
    - [核心原理](#核心原理)
    - [实践应用](#实践应用)
