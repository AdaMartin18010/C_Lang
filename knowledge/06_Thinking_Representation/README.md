...
| 文件 | 主题 | 用途 | 关联知识 |
|:-----|:-----|:-----|:---------|
| [01_Memory_Leak_Diagnosis.md](./01_Decision_Trees/01_Memory_Leak_Diagnosis.md) | 内存泄漏诊断 | 排查内存问题 | [内存管理](../01_Core_Knowledge_System/02_Core_Layer/06_Memory_Management.md) |
| [02_Segfault_Troubleshooting.md](./01_Decision_Trees/02_Segfault_Troubleshooting.md) | 段错误排查 | 调试崩溃问题 | [调试技术](../01_Core_Knowledge_System/05_Engineering/06_Debugging_Techniques.md) |
| [03_Performance_Bottleneck.md](./01_Decision_Trees/03_Performance_Bottleneck.md) | 性能瓶颈分析 | 优化决策 | [性能分析](../01_Core_Knowledge_System/05_Engineering/07_Performance_Profiling.md) |
| [04_Compilation_Error.md](./01_Decision_Trees/04_Compilation_Error.md) | 编译错误排查 | 编译问题解决 | [构建系统](../01_Core_Knowledge_System/05_Engineering/01_Build_Systems_Make.md) |
| [05_Concurrency_Debug.md](./01_Decision_Trees/05_Concurrency_Debug.md) | 并发问题调试 | 死锁/竞态 | [多线程](../01_Core_Knowledge_System/06_Advanced_Layer/07_MultiThreading.md) |
...
| 文件 | 主题 | 覆盖范围 |
|:-----|:-----|:---------|
| [01_C_Language_Overview.md](./03_Mind_Maps/01_C_Language_Overview.md) | C语言全景 | 完整知识图谱 |
...
| [03_Concurrency_Safety_Hierarchy.md](./05_Concept_Mappings/03_Concurrency_Safety_Hierarchy.md) | 并发安全层次 | 层次结构 |
...
2. 查阅 [08_Index/03_API_Quick_Reference.md](./08_Index/03_API_Quick_Reference.md) 函数速查
