...
- [DPDK高性能网络栈深度解析](#dpdk高性能网络栈深度解析)
  ...
  - [📖 核心概念详解](#-核心概念详解)
    - [1. DPDK架构](#1-dpdk架构)
    - [2. EAL初始化](#2-eal初始化)
    - [3. 数据包接收与发送](#3-数据包接收与发送)
    - [4. 内存池与无锁队列](#4-内存池与无锁队列)
    - [5. CPU亲和性与优化](#5-cpu亲和性与优化)
  - [⚠️ 常见陷阱](#️-常见陷阱)
    - [陷阱 DPDK01: NUMA不当](#陷阱-dpdk01-numa不当)
    - [陷阱 DPDK02: 内存泄漏](#陷阱-dpdk02-内存泄漏)
  - [✅ 质量验收清单](#-质量验收清单)
  - [深入理解](#深入理解)
    - [核心原理](#核心原理)
    - [实践应用](#实践应用)
