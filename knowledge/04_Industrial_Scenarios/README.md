...
| [02_FFT_Acceleration.md](./04_5G_Baseband/02_FFT_Acceleration.md) | FFT加速 | L5 | FFTW, Intel IPP |
...
| [02_Memory_Pool_Allocator.md](./05_Game_Engine/02_Memory_Pool_Allocator.md) | 内存池分配 | L4 | Custom Allocators |
...
| [02_Grover_Search.md](./06_Quantum_Computing/02_Grover_Search.md) | Grover搜索 | L5 | Quantum Algorithm |
...
| 文件 | 主题 | 难度 | 参考来源 |
|:-----|:-----|:----:|:---------|
| [01_Radiation_Hardening.md](./07_Space_Computing/01_Radiation_Hardening.md) | 抗辐射加固 | L5 | NASA Standards |
| [02_EDAC_Implementation.md](./07_Space_Computing/02_EDAC_Implementation.md) | EDAC实现 | L5 | Hamming Codes |
| [03_TMR_Design.md](./07_Space_Computing/03_TMR_Design.md) | TMR设计 | L5 | Fault Tolerance |
...
| [02_Error_Correction.md](./09_DNA_Storage/02_Error_Correction.md) | 纠错编码 | L5 | Reed-Solomon |
