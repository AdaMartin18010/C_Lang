...
- [5G 基带处理](#5g-基带处理)
  - [📑 目录](#-目录)
  - [概述](#概述)
  - [1. 5G NR 物理层](#1-5g-nr-物理层)
    - [1.1 物理层架构](#11-物理层架构)
    - [1.2 物理层参数](#12-物理层参数)
    - [1.3 C语言物理层数据结构](#13-c语言物理层数据结构)
  - [2. DSP编程](#2-dsp编程)
    - [2.1 DSP核心算法](#21-dsp核心算法)
    - [2.2 OFDM调制实现](#22-ofdm调制实现)
    - [2.3 信道估计算法](#23-信道估计算法)
  - [3. 实时处理](#3-实时处理)
    - [3.1 实时约束](#31-实时约束)
    - [3.2 实时调度实现](#32-实时调度实现)
  - [4. SIMD优化](#4-simd优化)
    - [4.1 SIMD指令集](#41-simd指令集)
    - [4.2 SIMD复数乘法](#42-simd复数乘法)
    - [4.3 性能对比](#43-性能对比)
  - [5. 开发与调试工具](#5-开发与调试工具)
    - [5.1 推荐的开发工具](#51-推荐的开发工具)
    - [5.2 测试向量和验证](#52-测试向量和验证)
  - [总结](#总结)
  - [深入理解](#深入理解)
    - [核心原理](#核心原理)
    - [实践应用](#实践应用)
