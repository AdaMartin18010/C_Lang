...
- [树莓派 Pico 开发平台 (Raspberry Pi Pico)](#树莓派-pico-开发平台-raspberry-pi-pico)
  - [📋 平台概述](#-平台概述)
    - [RP2040 芯片规格](#rp2040-芯片规格)
    - [相关开发板](#相关开发板)
  - [📑 目录](#-目录)
  - [⭐ 核心特性](#-核心特性)
    - [1. 双核架构优势](#1-双核架构优势)
    - [2. 可编程 I/O (PIO)](#2-可编程-io-pio)
    - [3. 丰富的外设接口](#3-丰富的外设接口)
  - [🎯 应用场景](#-应用场景)
    - [1. 实时控制系统](#1-实时控制系统)
    - [2. 协议转换网关](#2-协议转换网关)
    - [3. LED 显示控制](#3-led-显示控制)
    - [4. 音频应用](#4-音频应用)
    - [5. 教育与原型](#5-教育与原型)
  - [🛠️ 开发环境要求](#️-开发环境要求)
    - [硬件要求](#硬件要求)
  ...
  - [📚 与主文档的关系](#-与主文档的关系)
    ...
    - [技术关联](#技术关联)
  - [🚀 快速开始指引](#-快速开始指引)
    - [步骤 1: 创建第一个项目](#步骤-1-创建第一个项目)
    - [步骤 2: 编写主程序](#步骤-2-编写主程序)
    - [步骤 3: 编译与烧录](#步骤-3-编译与烧录)
    - [步骤 4: 多核编程示例](#步骤-4-多核编程示例)
  - [❓ 常见问题](#-常见问题)
    - [编译问题](#编译问题)
    - [烧录问题](#烧录问题)
    - [调试问题](#调试问题)
