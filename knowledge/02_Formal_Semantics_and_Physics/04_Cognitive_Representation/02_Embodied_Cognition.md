...
- [具身认知与调试](#具身认知与调试)
  ...
  - [📖 核心概念详解](#-核心概念详解)
    - [1. 具身认知理论](#1-具身认知理论)
      - [1.1 核心原则](#11-核心原则)
      - [1.2 在编程中的体现](#12-在编程中的体现)
    - [2. 调试的认知科学](#2-调试的认知科学)
      - [2.1 调试的心理模型](#21-调试的心理模型)
      - [2.2 空间推理与代码导航](#22-空间推理与代码导航)
    - [3. 可视化调试技术](#3-可视化调试技术)
      - [3.1 状态可视化](#31-状态可视化)
      - [3.2 执行轨迹追踪](#32-执行轨迹追踪)
    - [4. 具身调试技术](#4-具身调试技术)
      - [4.1 物理隐喻调试](#41-物理隐喻调试)
      - [4.2 手势与交互](#42-手势与交互)
    - [5. 调试工具设计原则](#5-调试工具设计原则)
      - [5.1 即时反馈](#51-即时反馈)
      - [5.2 多感官反馈](#52-多感官反馈)
  - [⚠️ 常见陷阱](#️-常见陷阱)
    - [陷阱 EC01: 忽视空间布局](#陷阱-ec01-忽视空间布局)
    - [陷阱 EC02: 过度抽象](#陷阱-ec02-过度抽象)
    - [陷阱 EC03: 反馈延迟](#陷阱-ec03-反馈延迟)
  - [✅ 质量验收清单](#-质量验收清单)
    - [5.3 调试工具链设计](#53-调试工具链设计)
    - [5.4 认知辅助调试](#54-认知辅助调试)
