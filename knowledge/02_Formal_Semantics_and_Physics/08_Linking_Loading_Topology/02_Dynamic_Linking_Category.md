...
- [动态链接范畴论](#动态链接范畴论)
  ...
  - [📖 核心概念详解](#-核心概念详解)
    - [1. 动态链接基础](#1-动态链接基础)
      - [1.1 共享库结构](#11-共享库结构)
      - [1.2 PLT/GOT机制](#12-pltgot机制)
    - [2. 延迟绑定实现](#2-延迟绑定实现)
      - [2.1 符号解析过程](#21-符号解析过程)
      - [2.2 立即绑定 vs 延迟绑定](#22-立即绑定-vs-延迟绑定)
    - [3. 运行时动态加载](#3-运行时动态加载)
      - [3.1 dlopen/dlsym实现](#31-dlopendlsym实现)
      - [3.2 插件系统设计](#32-插件系统设计)
    - [4. 高级主题](#4-高级主题)
      - [4.1 符号版本控制](#41-符号版本控制)
      - [4.2 预链接与GNU哈希](#42-预链接与gnu哈希)
  - [⚠️ 常见陷阱](#️-常见陷阱)
    - [陷阱 DL01: 符号可见性](#陷阱-dl01-符号可见性)
    - [陷阱 DL02: 初始化顺序依赖](#陷阱-dl02-初始化顺序依赖)
    - [陷阱 DL03: 内存管理不匹配](#陷阱-dl03-内存管理不匹配)
  - [✅ 质量验收清单](#-质量验收清单)
