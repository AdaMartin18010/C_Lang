...
- [📖 核心概念详解](#-核心概念详解)
  - [1. 重定位基础](#1-重定位基础)
    - [1.1 符号与引用](#11-符号与引用)
    - [1.2 重定位条目结构](#12-重定位条目结构)
  - [2. 群论视角](#2-群论视角)
    - [2.1 地址空间作为群作用](#21-地址空间作为群作用)
    - [2.2 符号解析的轨道](#22-符号解析的轨道)
  - [3. 段与重定位](#3-段与重定位)
    - [3.1 ELF段布局](#31-elf段布局)
    - [3.2 位置无关代码(PIC)](#32-位置无关代码pic)
  - [4. 链接时优化](#4-链接时优化)
    - [4.1 函数去重](#41-函数去重)
    - [4.2 段重排序](#42-段重排序)
  - [5. 重定位可视化](#5-重定位可视化)
- [⚠️ 常见陷阱](#️-常见陷阱)
  - [陷阱 RG01: 符号冲突](#陷阱-rg01-符号冲突)
  - [陷阱 RG02: 重定位溢出](#陷阱-rg02-重定位溢出)
  - [陷阱 RG03: 初始化顺序](#陷阱-rg03-初始化顺序)
- [✅ 质量验收清单](#-质量验收清单)
  - [5.2 动态重定位与PIE](#52-动态重定位与pie)
  - [5.3 重定位性能优化](#53-重定位性能优化)
- [深入理解](#深入理解)
  - [核心原理](#核心原理)
  - [实践应用](#实践应用)
  - [最佳实践](#最佳实践)
