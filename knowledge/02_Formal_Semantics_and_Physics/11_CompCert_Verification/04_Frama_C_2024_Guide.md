...
- [Frama-C 2024 完整指南](#frama-c-2024-完整指南)
  - [概述](#概述)
    - [核心组件](#核心组件)
  - [📑 目录](#-目录)
  - [安装与配置](#安装与配置)
  ...
  - [WP插件 (演绎验证)](#wp插件-演绎验证)
    ...
    - [证明策略](#证明策略)
    - [内存模型](#内存模型)
  - [E-ACSL (运行时验证)](#e-acsl-运行时验证)
    - [生成运行时检查](#生成运行时检查)
    - [示例](#示例)
  - [工业应用案例](#工业应用案例)
    - [案例1: 航天软件验证 (来自2024指南)](#案例1-航天软件验证-来自2024指南)
    - [案例2: 汽车AUTOSAR集成](#案例2-汽车autosar集成)
    - [案例3: 三菱电机10年经验](#案例3-三菱电机10年经验)
  - [高级技巧](#高级技巧)
    - [1. 批量分析](#1-批量分析)
    - [2. 自定义插件开发](#2-自定义插件开发)
