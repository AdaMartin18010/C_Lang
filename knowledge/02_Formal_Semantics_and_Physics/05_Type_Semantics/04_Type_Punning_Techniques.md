...
- [类型系统 [链接失效]](./README.md)
- [内存布局 [链接失效]](../../../01_Core_Knowledge_System/02_Core_Layer/01_Memory_Model.md)
- [严格别名规则 [链接失效]](../../../01_Core_Knowledge_System/09_Safety_Standards/MISRA_C_2023/README.md)

### 后续延伸

- [SIMD编程](../09_Physical_Machine_Layer/04_SIMD_Vectorization.md)
- [网络编程 [链接失效]](../../../03_System_Technology_Domains/15_Network_Programming/README.md)
